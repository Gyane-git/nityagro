        ...
        <div className="w-full max-w-360 mx-auto h-14 px-4 sm:px-6 lg:px-8 flex items-center justify-between gap-4">
            ...
            <div className="flex items-center gap-3 lg:gap-6 shrink-0 ">
              ...
              <div className="relative hidden sm:block mr-5" ref={categoryRef}>
                ...
                >
                  ...
                  <span className="hidden lg:inline text-[14px] text-[#266A3F] font-semibold whitespace-nowrap">
                    ...
                    {link.hasDropdown ? (
                      <>
                        <button
                          ...
                          className="flex items-center gap-1 text-[14px] font-semibold text-[#2D333A] hover:text-[#00462C] transition-colors"
                        >
                          {link.label}
                          <ChevronDownIcon />
                        </button>
                        ...
                        >
                          {link.childLinks.map((child) => (
                            <Link
                              ...
                              className="block px-5 py-3 text-[12px] text-[#00462C] hover:bg-[#F5F8F6]  transition border-b border-gray-300 last:border-b-0"
                            >
                              {child.label}
                            </Link>
                          ))}
                      ...
                      <a
                        href={link.href}
                        className="text-[14px] font-semibold text-[#2D333A] hover:text-[#00462C] transition-colors"
                      >
                        {link.label}
                      </a>
                    )}
          ...
          <div>
            <div className="flex items-center gap-4 sm:gap-5 text-[#1a1a1a] shrink-0">
              ...
              {!authReady ? (
                <span
                  className="hidden lg:block h-7 w-18 rounded-md bg-gray-100"
                  aria-hidden="true"
                />
              ) : isLoggedIn ? (
                <>
                  ...
                  <Link
                    href={accountHref}
                    className="hidden lg:flex items-center gap-1.5 text-[15px] font-medium hover:text-[#00462C] transition-colors"
