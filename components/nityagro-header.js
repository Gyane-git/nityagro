...
/* UserIcon — plain SVG (no Link, click handled by button) */
const UserIcon = () => (
  <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
...
export default function Header() {
  ...
  /* ── Auth modal state (controls Login / Signup / OTP / Forgot / Reset) ── */
  ...
  return (
    <>
          ...
          <div className="max-w-[1440px] mx-auto h-[71px] px-8 flex items-center justify-between gap-6">
            ...
            <div className="flex items-center gap-5 text-[#1a1a1a] shrink-0">
              ...
              <button className="relative hover:text-[#00462C] transition-colors">
                <WishlistIcon />
                <span className="absolute -top-[7px] -right-[7px] min-w-[17px] h-[17px] px-[3px] bg-[#00462C] text-white text-[10px] font-bold rounded-full flex items-center justify-center leading-none">
                  8
                </span>
              </button>
              ...
              {/* ── Log in → opens LoginModal as popup ── */}
              <button
      ...
      {/* ── Auth modals portal — handles Login/Signup/OTP/Forgot/Reset ── */}
