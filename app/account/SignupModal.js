      ...
      <div className="flex flex-col" style={{ padding: "32px 36px 28px" }}>
        ...
        <form onSubmit={handleSignup} className="flex flex-col gap-4">
          ...
          <div className="flex flex-col gap-1.5">
            ...
            <input type="text" placeholder="Enter your full name" value={form.name} onChange={set("name")}
          ...
          <div className="flex flex-col gap-1.5">
            ...
            <div className="relative">
              <input type={showPw ? "text" : "password"} placeholder="Create a password" value={form.password} onChange={set("password")}
          ...
          <div className="flex flex-col gap-1.5">
            ...
            <div className="relative">
              <input type={showCPw ? "text" : "password"} placeholder="Re-enter your password" value={form.confirm} onChange={set("confirm")}
                className={inputClass} style={{ height: "48px", paddingRight: "42px" }} required />
