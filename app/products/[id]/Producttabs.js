...
const getTabContent = (product) => ({
  "Product Details":
    product?.productDescription?.trim() || "No product details available.",
  "Nutritional Information":
    product?.nutritionInfo?.trim() || "No nutritional information available.",
  "Cooking instructions/ Usage":
    product?.cookingInstruction?.trim() || "No cooking instruction available.",
  "Storage Instructions":
    product?.storageInstruction?.trim() || "No storage instruction available.",
});
