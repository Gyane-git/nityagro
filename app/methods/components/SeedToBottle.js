    ...
    >
      ...
      <div className="mb-10 sm:mb-12 lg:mb-16">
        ...
        <div className="flex flex-col sm:flex-row sm:items-start sm:justify-between gap-4 sm:gap-8 lg:gap-16">
          ...
          <p className="w-full sm:w-80 lg:w-95 shrink-0 sm:pt-2.5 text-[13px] sm:text-[14px] lg:text-[15px] font-light leading-[1.8] text-[#4a4a46]">
            {data?.desc}
          </p>
        </div>
      </div>
...
<div className="flex-1">
  {/* ICON + TITLE */}
  <div className="flex items-center gap-3 sm:gap-4 mb-3 lg:mb-4">
    <div
      className="
        text-[28px]
        sm:text-[32px]
